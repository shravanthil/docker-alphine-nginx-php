...
LABEL Description="PHP Nginx for development"
...
## Nginx configuration
COPY server/development/nginx.conf /etc/nginx/nginx.conf
## PHP Ini Custom
COPY server/development/custom.ini /etc/php7/conf.d/custom.ini
